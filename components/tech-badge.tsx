  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        <span className="text-sm font-medium text-foreground leading-none">{tech.name}</span>
        {tech.years_experience && (
          <span className="text-xs text-muted-foreground mt-0.5">{tech.years_experience}yr</span>
        )}
      </div>
