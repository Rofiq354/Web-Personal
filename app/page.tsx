    ...
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[calc(100vh-64px)] flex items-center">
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full bg-amber/5 blur-3xl" />
          <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-steel/5 blur-3xl" />
          {/* Grid lines */}
          <div
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-3xl">
            ...
            {profile?.open_to_work && (
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-amber/10 border border-amber/20 rounded-full text-amber text-sm font-medium mb-8 animate-fade-in">
                <Sparkles size={14} />
            ...
            {profile?.tagline && (
              <p
                className="text-lg text-muted-foreground mb-6 animate-fade-up"
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce-slow">
          <div className="w-6 h-10 rounded-full border-2 border-muted flex items-start justify-center pt-1.5">
